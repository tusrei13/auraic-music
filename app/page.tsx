    ...
    <div className="p-8 space-y-10 h-full overflow-y-auto scrollbar-none pb-28">
      ...
      <div className="flex items-end justify-between border-b border-white/10 pb-6">
        ...
        <div className="hidden md:flex gap-3">
          ...
          <button 
            onClick={playMix}
            className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold px-4 py-2 rounded-full shadow-[0_0_15px_rgba(99,102,241,0.4)] transition-all flex items-center gap-2">
